*******************************************************************
*   subroutine for higgs field updating with  heatbath algorithm  *
*   input  : measflag                                             *
*   output : accept                                               *
*******************************************************************
     
      subroutine ahiggs2(measflag,accept)
...
*   propose a new configuration for the Higgs field       
      ...
      call gauss(g1,width,ownhalfvol(3)) 
      call gauss(g2,width,ownhalfvol(3))
      call gauss(g3,width,ownhalfvol(3))

       do site=1,ownhalfvol(3)
        a_n(1,site)=g1(site)+beta_a*force(1,site)*cxval(site)
        a_n(2,site)=g2(site)+beta_a*force(2,site)*cxval(site)
        a_n(3,site)=g3(site)+beta_a*force(3,site)*cxval(site)
       enddo   
